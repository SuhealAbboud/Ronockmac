...
System.setProperty('webdriver.chrome.driver', 'Users\\khaledodat\\Desktop\\Ronock\\chromedriver.exe')
...
def dd() {
	...
	Process process=runtime.exec('Users\\khaledodat\\Desktop\\Ronock\\test.exe')
}

def test2() {
	Runtime runtime = Runtime.getRuntime()
	Process process=runtime.exec('Users\\khaledodat\\Desktop\\Ronock\\suheal.exe')
}
